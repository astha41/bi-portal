...
const EMBED_ID = "4c53a54c-df7e-4f25-8b75-91b6d76f8b2c";
const DASH_ID = "project-dash";
const ALLOWED_ROLES = ["admin", "manager", "finance manager"];
...
export default function ProjectDashboard({ user, role }) {
  ...
  // ensure mount height large and embed
  ...
  // inline styles
  const styles = {
    page: { padding: 20, display: "flex", flexDirection: "column", minHeight: "calc(100vh - 64px)", boxSizing: "border-box", gap: 12 },
